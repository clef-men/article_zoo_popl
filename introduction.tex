...
\paragraph{Artifact} Our entire development (code and mechanized proofs) is publicly available at \url{https://github.com/clef-men/zoo/tree/popl26}; throughout the paper we link to them using clickable icons, for example \refLibTheoriesFile{zoo_saturn/mpmc_stack_1}.
