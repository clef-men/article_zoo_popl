...
We have amply covered related work on verification of concurrent fine-grained data structures in the paper.
We focus here on program verification and the question of physical equality.
