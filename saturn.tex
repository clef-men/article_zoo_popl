...
This subtlety was missing from the original implementation designed for non-garbage-collected languages,
but \Saturn implements it (\href{https://github.com/ocaml-multicore/saturn/pull/64}{saturn\#64}).
