...
In particular, \CFML~\citep*{DBLP:books/hal/Chargueraud23} and \Osiris~\citep*{osiris} target \OCaml.
...
%
There is also a discussion of similar optimizations in \Lean in \citep*{lean-pointer-optimizations}.
