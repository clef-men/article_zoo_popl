...
Consider, for example, the \OCaml implementation of a concurrent stack

In \cref{fig:stack} we include the \OCaml implementation of a simple lock-free concurrent stack~\cite{thomas1986systems}, and its automatic translation to \ZooLang, demonstrating that readability is preserved for this program.
